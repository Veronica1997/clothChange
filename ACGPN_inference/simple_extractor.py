...
def get_arguments():
    ...
    parser.add_argument("--model-restore", type=str, default='/home/ubuntu/00-workplace/ClothChange/ACGPN_inference/exp-schp-201908261155-lip.pth', help="restore pretrained model parameters.")
    parser.add_argument("--gpu", type=str, default='0', help="choose gpu device.")
    parser.add_argument("--input-dir", type=str, default='/home/ubuntu/00-workplace/ClothChange/ACGPN_inference/input', help="path of input image folder.")
    parser.add_argument("--output-dir", type=str, default='/home/ubuntu/00-workplace/ClothChange/Data_preprocessing/test_label', help="path of output image folder.")
